...
namespace Penumbra.Hooks
{
    public class GameResourceManagement
    {
        ...
        public GameResourceManagement( DalamudPluginInterface pluginInterface )
        {
            ...
            var loadCharacterResourcesAddress = scanner.ScanText( "E8 ?? ?? ?? 00 48 8D ?? ?? ?? 00 00 E8 ?? ?? ?? 00 33 D2" );
            ...
            _characterResourceManagerAddress = scanner.GetStaticAddressFromSig( "48 8B 0D ?? ?? ?? ?? E8 ?? ?? ?? 00 48 8D ?? ?? ?? 00 00 E8 ?? ?? ?? 00 33 D2" );
